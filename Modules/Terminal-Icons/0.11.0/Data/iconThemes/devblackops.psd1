    ...
    Types = @{
        Directories = @{
            ...
            WellKnown = @{
                ...
                'routes'                = 'nf-md-routes'
                'upload'                = 'nf-md-upload'
                'uploads'               = 'nf-md-upload'
                'data'                  = 'nf-oct-database'
                'database'              = 'nf-oct-database'
                'dataset'               = 'nf-oct-database'
                'datasets'              = 'nf-oct-database'
                'utils'                 = 'nf-custom-folder_config'
                'util'                  = 'nf-custom-folder_config'
                'infra'                 = 'nf-md-connection'
                'internal'              = 'nf-oct-lock'
                'config'                = 'nf-custom-folder_config'
                'configs'               = 'nf-custom-folder_config'
            }
        }
        ...
        Files       = @{
            ...
            WellKnown               = @{
                ...
                'README.md'                     = 'nf-cod-markdown'
                'README.txt'                    = 'nf-cod-markdown'
                'README'                        = 'nf-cod-markdown'
                ...
                'docker-compose-test.yml'       = 'nf-dev-docker'
                'docker-compose-hlg.yml'        = 'nf-dev-docker'
                'docker-compose-jobs.yml'       = 'nf-dev-docker'
                'docker-compose-staging.yml'    = 'nf-dev-docker'
            ...
            # Environment
            '.env'                  = 'nf-cod-settings'
            '.env.sample'           = 'nf-cod-settings'
            '.env.example'          = 'nf-cod-settings'
            '.env.development'      = 'nf-cod-settings'
            '.env.staging'          = 'nf-cod-settings'
            '.env.production'       = 'nf-cod-settings'
        }
    }
}
